...
const rootClasses = {
  center: "p-0 md:p-4 md:p-5",
  bottom: "p-0 md:p-5 pb-0",
};
const containerClasses = {
  center: "h-screen md:h-auto max-h-full top-1/2 -translate-y-1/2 rounded-lg",
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "modal-root fixed bg-black bg-opacity-70 inset-0 z-[110] overflow-y-auto scrollbar",
          ...
          >
            ...
            >
              <div
                className={cn(
                  "bg_modal w-full md:w-auto absolute left-1/2 transform -translate-x-1/2 shadow-xl",
                  containerClasses[variant],
                  containerClassName
                )}
                // className={cn(
                //   "bg_modal w-full md:w-auto absolute left-1/2 transform -translate-x-1/2 shadow-xl overflow-x-hidden overflow-y-auto scrollbar",
                //   containerClasses[variant],
                //   containerClassName
                // )}
              >
                ...
                <div
                  ref={modalInnerRef}
                  className="bg_modal h-full rounded-lg"
