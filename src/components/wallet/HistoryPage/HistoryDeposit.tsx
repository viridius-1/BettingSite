...
const HistoryDeposit = (props: IHistoryDepositProps) => {
  ...
  const columns: Array<Column<object>> = [
    ...
    {
      Header: (
        <p className="ml-0 md:ml-[2rem] styleHeader">{t(`text-bankSend`)}</p>
      ),
      accessor: "-",
      Cell: (value: any): any => {
        return (
        ...
        >
          ...
          <div className="flex flex-col xl:flex-row justify-between space-x-0 xl:space-y-0 xl:space-x-10 md:py-[30px] px-mobile md:px-10">
            <div className="flex justify-between text-left md:text-left flex-col">
              ...
              <p className="text-whiteDefault-60 text-sm md:text-[14px] font-normal uppercase">
                Form #{Data._id}
              </p>

              <h1 className="text-lg md:text-[18px] text-white mt-[0.4rem] uppercase">
              {t(`text-deposit`)}
              </h1>
            </div>
          ...
          <div className="flex flex-col xl:flex-row justify-between space-x-0 space-y-5 xl:space-y-0 md:py-[30px] px-mobile md:px-10">
            <div className="flex md:justify-between flex-col md:flex-row text-left w-full">
              <div className="md:w-1/2 flex w-full flex-col mb-5">
                ...
                <div className="mt-[0.5rem] max-h-[34px] text-white">
                
                  {BankIcon(Data?.bank, 1.8)}
              ...
              <div className="md:w-1/2">
                ...
                <div className="mt-[1.5rem] max-h-[34px] text-white">
                {BankIcon(Data.sender_bank, 1.8)}
                </div>
                <p className="text-whiteDefault-100 text-sm font-normal mt-[0.5rem]">
            ...
            {Data.status == "approved" ? (
              <div className="flex items-center w-full md:w-[195px] h-fit justify-start md:justify-end">
                <p className="flex font-normal flex-row uppercase md:flex-col text-white/30 order-2 md:order-1 text-xs text-right mr-4">
                  <span className=" font-normal">Form Approved</span>
          ...
          <div className="px-10 py-[30px]">
            <button
              ...
              className="hidden md:flex items-center group  opacity-70 space-x-2 hover:opacity-100 transition duration-200 ease-in-out"
            >
              <div className="flex items-center justify-center bg-whiteDefault-10 rounded-full w-[20px] h-[20px]">
                <FiChevronLeft strokeWidth={3.2} className="bg-transparent font-bold group-hover:text-white transition duration-200 ease-in-out text-whiteDefault-100" />
              </div>
              <span className="text-base  text-whiteDefault-50 group-hover:text-white transition duration-200 ease-in-out font-normal">
                Kembali
              </span>
            </button>
          </div>
