...
interface IDepositNormalProps {
  setDepositInstant: (instant: boolean) => void;
  scrollToTop: () => void;
}

const DepositNormal = (props: IDepositNormalProps) => {
  ...
  const [selectedPresetAmount, setSelectedPresetAmount] = useState(0);
  ...
  const onSubmit = () => {
    ...
    setDepositValueReg(currencyFormat(DepositValue).toString());
  };
      ...
      <div className="bg_content_container flex flex-col lg:bg-none w-full lg:rounded-10 text-white py-6 md:px-0 lg:py-0">
        ...
        {instantDepo == true ? (
          <div className="flex justify-around px-mobile  mb-[1rem] lg:hidden">
            <button
              onClick={() => {
                toast.warning("Anda sekarang berada di Deposit Normal");
              }}
            ...
            <button
              onClick={() => {
                props.setDepositInstant(true);
              }}
              className="btn-wallet-list-nominal active:translate-y-[2px]   hover:bg-[#FFC700]/10 hover:text-[#FFC700] hover:border-[1px] hover:border-[#FFC700] animate-transationNormal"
            >
              Deposit Instant{" "}
            </button>
          </div>
          ...
          <div className="w-full lg:w-8/12 ">
            <div className="flex flex-col    rounded-b-[4px]">
              <div className="text-[16px] text-left font-medium    bg-[#d3f2ff05]  md:bg-[#d3f2ff0a]   p-[14px] flex items-center border-[1px] rounded-t-[4px] border-[#B9D6FF]/10">
                ...
                <span>
                  Pilih Rekening Anda{" "}
                  {instantDepo == true ? "(Deposit Normal)" : ""}
                </span>
              </div>
            ...
            <div className="flex flex-col mt-[28px]  md:mt-[40px] rounded-b-[4px]">
              <div className="md:my-[20px] md:my-[0px] w-full ">
                ...
                <div className="px-[14px] pt-[1rem] pb-[14px]  bg-[#d3f2ff0a] md:bg-[#d3f2ff05]  rounded-b-[4px]  border-[#B9D6FF]/10 border-[1px]">
                  ...
                  {data ? (
                    <DropdownCustom
                      data={data ? getSelectedBankList(data) : []}
                  ...
                  <div className="h-[42px] md:h-[52px] relative flex justify-center lg:justify-start self-center mx-auto md:mx-0 mb-4 items-center">
                    ...
                    <div className="relative flex w-full items-center mx-[6px]  h-[48px]  md:h-[52px]">
                      <CurrencyInput
                        ...
                        groupSeparator="."
                        onValueChange={(value) => {
                          updateDepositValue(Number(value));
                        }}
                        value={DepositValue}
          ...
          <div className="w-full lg:w-8/12 flex flex-col justify-center">
            ...
            <div className="  border-[1px] rounded-b-[4px] border-[#B9D6FF]/10 bg-[#d3f2ff02] p-[14px]">
              ...
              <div className="flex relative item-left h-fit justify-left md:justify-start md:text-left text-[24px] mt-[12px] md:mt-[16px]  font-semibold md:font-bold">
                ...
                {currencyFormat(isNaN(DepositValue) ? "0" : DepositValue)}
                <button
                  onClick={async () => {
                    copy(DepositValue.toString());
              ...
              {/* <div className="bg-[#D3F2FF]/10 px-[10px] py-[10px] text-[12px] font-normal rounded-[3px] mt-[10px] relative">
                <div
                  className="absolute   z-50 flex transition duration-200 ease-in-out px-4 py-2 rounded-md first-letter:
                 before:content-[''] before:absolute before:bottom-8  before:right-1/2  before:mb-[-0.34rem] ml-[3rem] before:rotate-[90deg] before:border-8 before:border-y-transparent before:border-l-transparent before:border-[#D3F2FF]/10"
                ></div>
                <p>
              ...
              <div className="flex mt-[24px]">
                <div className="w-full">
                  ...
                  <div className="flex w-full bg- justify-between md:mt-[20px] mt-[18px]">
                    <span className="text-[14px] font-normal text-[#D3F2FF]/60">
                      Bank Pembayaran
                    </span>
                    <div>{BankIcon(DataRekeningPembayaran?.bank, 1.5)}</div>
                  </div>
                  <div className="flex w-full bg- justify-between mt-[18px]">
                    <span className="text-[14px] font-normal text-left text-[#D3F2FF]/60">
                      {DataRekeningPembayaran.type == "bank"
                        ? "Nomor Rekening"
                        : "Nomor Handphone"}
                    </span>
                    <div className="text-[14px] font-normal text-[#D3F2FF]/60">
                  ...
                  <div className="flex w-full bg- justify-between mt-[18px]">
                    ...
                    <div className="text-[14px] font-normal uppercase text-[#D3F2FF]/60">
              ...
              <div className="space-y-3 text-sm font-normal mt-[24px] mb-[25px]">
                <div className="flex text-left items-center space-x-3">
                  ...
                  <p className="text-[#D3F2FF]/60 text-[12px] ont-normal leading-[15.12px]">
        ...
        <div className="w-full md:w-5/12 md:max-w-[415px]  px-mobile flex flex-col mt-[30px] justify-center">
          ...
          {dataDeposit[0] ? (
            <div className="mt-[24px] w-full bg-[#B9D6FF]/5 flex justify-center flex-col rounded-[4px]">
              ...
              <div className="px-[16px] pb-[20px]">
                <h1 className="text-[14px] font-medium text-left  text-white">
          ...
          {dataDeposit[0] ? (
            <div className="mt-[10px] w-full bg-[#B9D6FF]/5 flex justify-center flex-col rounded-[4px]">
              <div className="bg-[#1AA9E7]/10 mt-[15px] min-h-[27px] mx-[13px] mb-[20px] p-[6px] flex flex-row justify-center items-center rounded-[4px]">
              ...
              <div className="px-[16px] pb-[20px]">
                ...
                <div className="flex  w-full">
                  ...
                  <div className="w-5/12 md:w-4/12 flex   md:justify-start flex-col mt-[16px]">
                    <h2 className=" text-[12px] text-left font-normal  text-[#D3F2FF]/60">
                      {dataDeposit[0].type == "bank"
                        ? "Nama Rekening"
                        : "Nama Handphone"}
                    </h2>
