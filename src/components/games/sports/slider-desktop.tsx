      ...
      <div className="slider-mobile-gap-title-card">
        ...
        >
          ...
          {data?.map((item: any, index: number) => (
            <SwiperSlide
              key={index}
              className="w-[450px] h-[250px] hover:relative hover:z-10 hover:-translate-y-[10px] transition duration-[200] my-[10px]"
            >
              <div className="pb-[6px] drop-shadow-image cursor-pointer">
                <CardBanner
